...
log_on_with_facebook = driver.find_element(By.XPATH, value='//*[@id="page"]/div[1]/div[3]/div/div[3]/div/div[1]/div[1]/div[1]/div/div/a')
...
while True:
    try:
        ...
        try:
            pop_up = driver.find_element(By.XPATH, value='/html/body/aside/section/div[1]/div/div[1]/div/section/div/h1')
        except selenium.common.exceptions.NoSuchElementException:
            skip_button = driver.find_element(By.XPATH,
                                              value='/html/body/aside/section/div[1]/div/div/section/div/div/div/div[2]/div')
            skip_button.click()
        else:
